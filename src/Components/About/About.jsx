      ...
      <div className="containerAbout">
        <div className="about-left">
          ...
          <div className="text-sm poppins-light">
            Somos uma pequena equipe sem fins lucrativos que visa o bem estar
            dos animais. Nosso objetivo é conseguir reduzir o número de animais
            que vivem nas ruas, alimentá-los, vaciná-los e mentê-los seguros.
            Nos consideramos pais adotivos temporários de todos os animais pois
